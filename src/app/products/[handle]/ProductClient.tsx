        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:sticky lg:top-[144px]">
            ...
            >
              ...
              {/* Local pickup (static banner, always visible) */}
              <div className="mt-6 border border-hairline p-4 flex items-start gap-3">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-smoke flex-shrink-0 mt-0.5">
                ...
                <div>
                  <p className="text-xs text-ink font-medium">Milton pickup available.</p>
                  <p className="text-xs text-smoke mt-1">Address emailed post-purchase.</p>
                </div>
              </div>
