...
const ARTICLE = {
  ...
  body: [
    ...
    { type: 'p', text: 'This is the quality we think about most at NÜRHAUS. Not visibility. Not statement. Not even beauty, exactly. Presence. The sense that a woman and her clothes are the same thing — not competing, not contrasting, not performing.' },
    ...
    { type: 'p', text: 'The women who wear NÜRHAUS are not a category. They are professionals, mothers, travelers, artists. They are observant and secular, traditional and modern. What they share is a preference for dressing in a way that feels like themselves — not a costume, not a statement, not an accommodation.' },
    ...
    <div className="page-enter">
      ...
      <section className="relative h-[65vh] overflow-hidden">
        ...
        <div className="relative z-10 h-full site-max site-px flex flex-col justify-end pb-16">
          ...
          >
            ...
            <h1 className="font-display italic text-primary text-[2.4rem] md:text-[4.5rem] leading-tight tracking-tight max-w-3xl">
              {ARTICLE.title}
            </h1>
          </motion.div>
        </div>
      ...
      <div className="site-max site-px py-16 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_260px] gap-16 lg:gap-24">
          ...
          <article>
            <motion.p
              className="font-display text-xl md:text-2xl italic text-accent mb-12 max-w-2xl leading-relaxed"
              initial={{ opacity: 0, y: 24 }}
              animate={{ opacity: 1, y: 0 }}
