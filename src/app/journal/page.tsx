...
const ARTICLES = [
  ...
  },
  {
    ...
    excerpt: "Our founder traveled to the Grand Bazaar’s textile district to find the linen-viscose blend that would become Amelie. What she found instead was a lesson in patience.",
    readTime: '5 min read',
  ...
  },
  {
    ...
    excerpt: 'The mills of Nishijin in Kyoto weave fabric that has been in continuous production since the 8th century. We visit the weavers behind Layla.',
    readTime: '8 min read',
