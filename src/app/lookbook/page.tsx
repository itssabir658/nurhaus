    ...
    <div className="page-enter bg-midnight">
          ...
          >
            ...
            <div className={`relative z-10 h-full site-max site-px flex flex-col justify-end pb-16 md:pb-24 ${alignClass}`}>
              ...
              >
                ...
                <h2 className="font-display italic text-primary text-[3rem] md:text-[6rem] leading-[0.92] tracking-tight max-w-3xl mb-3">
                  {scene.text}
                </h2>
                {scene.subtext && (
      ...
      <section className="relative bg-midnight text-primary">
        <div className="site-max site-px py-32 md:py-56 text-center">
          ...
          <motion.h2
            className="font-display italic text-[3rem] md:text-[7rem] leading-[0.92] tracking-tight mb-12"
            initial={{ opacity: 0, y: 32 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }}
