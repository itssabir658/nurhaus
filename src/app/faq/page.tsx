...
const CATEGORIES = [
  ...
  },
  {
    ...
    label: 'Care',
    faqs: [
      { q: 'How should I care for my NÜRHAUS pieces?', a: 'Care instructions vary by fabric and are printed on the garment label. Most of our pieces are hand-wash or dry-clean only. Detailed care guidance is included in the product packaging.' },
